/*
		...
		Functionallity: Implements PLL_Init(freq) to configure the 
		TM4C123 system clock by setting RCC/RCC2 to use the 400 MHz 
		PLL and divide to the requested bus frequency.
*/ 
